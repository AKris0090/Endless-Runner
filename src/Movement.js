class Movement extends Phaser.Scene {
    ...
    create() {
        ...
        this.scoreLeft = this.add.text(borderUISize + borderPadding, borderUISize, "movementScene - left click to switch", scoreConfig);
    ...
    update() {
        if(scene1flipflop) {
            ...
            this.player.play(playerMovement + '-' + playerDirection2, true);
        }
    }   
}